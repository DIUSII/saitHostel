...
class TargetResolver {
  ...
  async resolve(rootDir = this.options.projectRoot) {
  ...
  async resolvePackageTargets(rootDir) {
    ...
    for (let targetName of COMMON_TARGETS) {
      ...
      if (typeof targetDist === 'string' || pkgTargets[targetName]) {
        ...
        if (typeof targetDist === 'string') {
          ...
          distDir = (_this$options$distDir = this.options.distDir) !== null && _this$options$distDir !== void 0 ? _this$options$distDir : _path.default.resolve(pkgDir, DEFAULT_DIST_DIRNAME, targetName);
        }
    ...
    for (let targetName in pkgTargets) {
      ...
      if (distPath == null) {
        ...
        distDir = (_this$options$distDir2 = this.options.distDir) !== null && _this$options$distDir2 !== void 0 ? _this$options$distDir2 : _path.default.resolve(pkgDir, DEFAULT_DIST_DIRNAME, targetName);
      } else {
    ...
    if (targets.size === 0) {
      ...
      targets.set('default', {
        name: 'default',
        distDir: (_this$options$distDir3 = this.options.distDir) !== null && _this$options$distDir3 !== void 0 ? _this$options$distDir3 : _path.default.resolve(this.fs.cwd(), DEFAULT_DIST_DIRNAME),
