...
const internalBundleGraphToBundleGraph = new _utils.DefaultWeakMap(() => new WeakMap()); // Friendly access for other modules within this package that need access
...
class BundleGraph {
  ...
  getChildBundles(bundle) {
    return _classPrivateFieldGet(this, _graph).getChildBundles((0, _Bundle.bundleToInternalBundle)(bundle)).map(bundle => new _Bundle.Bundle(bundle, _classPrivateFieldGet(this, _graph), _classPrivateFieldGet(this, _options)));
  }
