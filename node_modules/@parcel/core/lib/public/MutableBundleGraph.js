...
const internalMutableBundleGraphToMutableBundleGraph = new _utils.DefaultWeakMap(() => new WeakMap());
...
class MutableBundleGraph {
  ...
  constructor(graph, options) {
    ...
    let existing = internalMutableBundleGraphToMutableBundleGraph.get(options).get(graph);
    ...
    internalMutableBundleGraphToMutableBundleGraph.get(options).set(graph, this);
  }
  ...
  createBundle(opts) {
    ...
    let bundleNode = {
      ...
      value: {
        ...
        env: opts.env ? (0, _Environment.environmentToInternalEnvironment)(opts.env) : (0, _nullthrows.default)(entryAsset).value.env,
        entryAssetIds: entryAsset ? [entryAsset.value.id] : [],
        pipeline: entryAsset ? entryAsset.value.pipeline : null,
        filePath: null,
        isEntry: opts.isEntry,
        isInline: opts.isInline,
        isSplittable: (_opts$isSplittable = opts.isSplittable) !== null && _opts$isSplittable !== void 0 ? _opts$isSplittable : entryAsset === null || entryAsset === void 0 ? void 0 : entryAsset.value.isSplittable,
  ...
  getTotalSize(asset) {
    return _classPrivateFieldGet(this, _graph).getTotalSize((0, _Asset.assetToInternalAsset)(asset).value);
  }

  isAssetInAncestorBundles(bundle, asset) {
    return _classPrivateFieldGet(this, _graph).isAssetInAncestorBundles((0, _Bundle.bundleToInternalBundle)(bundle), (0, _Asset.assetToInternalAsset)(asset).value);
  }

  removeAssetGraphFromBundle(asset, bundle) {
    _classPrivateFieldGet(this, _graph).removeAssetGraphFromBundle((0, _Asset.assetToInternalAsset)(asset).value, (0, _Bundle.bundleToInternalBundle)(bundle));
  }
