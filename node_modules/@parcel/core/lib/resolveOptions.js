...
async function resolveOptions(initialOptions) {
  ...
  return {
    ...
    publicUrl: (_initialOptions$publi = initialOptions.publicUrl) !== null && _initialOptions$publi !== void 0 ? _initialOptions$publi : '/',
    distDir: initialOptions.distDir != null ? _path.default.resolve(initialOptions.distDir) : null,
